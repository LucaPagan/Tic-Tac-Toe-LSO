...
// Includiamo il codice C da testare
// Nota: In un progetto reale, queste funzioni dovrebbero essere in file separati
extern "C" {
...
// Helper per creare una matrice 3x3
...
TEST(TrisLogic, Draw) {
    ...
    grid[1][0] = 1; grid[1][1] = 1; grid[1][2] = 2;
